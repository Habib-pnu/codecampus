...
export const mockClassGroups: ClassGroup[] = [
  // --- PNU Classes ---
  {
    ...
    pendingJoinRequests: [
       { userId: 'student-pnu-003', fullName: 'Piti Rakdee', username: 'student.pnu3', studentId: 'S65003', requestedAt: new Date().toISOString() },
    ],
    assignedChallenges: [],
    status: 'active',
    ...
    challenges: [
      {
        ...
        language: "cpp",
        targetCodes: [
          { id: "tc-cpp-1-1", code: "#include <iostream>\nint main() { int x; std::cin >> x; std::cout << \"Val: \" << x; return 0; }", requiredOutputSimilarity: 100, description: { en: "Read and print an integer" }, points: 100, testCases: [{ input: "42" }] }
        ]
      },
      {
        id: "ch-cpp-001-2",
        ...
        language: "cpp",
        targetCodes: [
          { id: "tc-cpp-2-1", code: "#include <iostream>\nint main() { int x; std::cin >> x; if(x%2==0){std::cout << \"Even\";} else {std::cout << \"Odd\";} return 0; }", requiredOutputSimilarity: 100, description: { en: "Even or Odd" }, points: 100, testCases: [{ input: "10" }, {input: "7"}] }
        ]
      }
    ]
  },
    ...
    challenges: [
      {
        ...
        language: "python",
        targetCodes: [
          { id: "tc-py-1-1", code: "name = input()\nprint(f'Hello, {name}')", requiredOutputSimilarity: 100, description: { en: "Greeting" }, points: 100, testCases: [{ input: "Python" }] }
        ]
      }
    ]
  }
